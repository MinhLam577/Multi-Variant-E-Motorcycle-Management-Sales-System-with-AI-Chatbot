        ...
        <>
            {cartListObserver?.map((item) => (
                <tr key={item.id}>
                    ...
                    <td>
                        <input
                            className="text-center !border-b !border-solid !border-gray-300 py-2 w-full max-w-24 focus:outline-none focus:!border-gray-950 "
                            type="number"
                            min={1}
                            ...
                            onBlur={() =>
                                handleQuantityBlur(
                                    item.id,
                                    item.skus.skus_quantity_remaining
                                )
                            }
                        />
                    </td>
