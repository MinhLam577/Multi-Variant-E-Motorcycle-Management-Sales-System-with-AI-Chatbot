            ...
            <div className="row">
                ...
                <div className="col-md-9 col-xl-5">
                    <div className="home1_divider_content">
                        ...
                        <p className="para">
                            At minhdeptrai.site what matters to us is making
                            your car search and buying experience as simple as
                            possible, so you can find the right car quickly and
                            get on with making it yours.
                        </p>
                    </div>
                </div>
                {/* End col-md-9 */}
