...
import BlogCategoriesObservable from "./blogCategory.store";
export class RootStore {
    ...
    blogCategoryObservable: BlogCategoriesObservable;
    constructor() {
        this.blogCategoryObservable = new BlogCategoriesObservable(this);
