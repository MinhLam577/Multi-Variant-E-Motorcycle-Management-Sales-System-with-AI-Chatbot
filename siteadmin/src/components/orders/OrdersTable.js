...
const getColumnsConfig = ({ handleViewOrders, handleViewUser }) => {
    return [
        {
            title: "Mã đơn hàng",
            dataIndex: "order_id",
                ...
                <>
                    <div>
                        <span
                            ...
                            onClick={() => {
                                handleViewUser(createdBy.userId);
                            }}
                        >
                            {createdBy?.fullname}{" "}
                        </span>
                ...
                <>
                    <div>
                        ...
                        <span
                            ...
                            onClick={() =>
                                handleCopy(orderAddress?.receiverName)
                            }
                        >
                    ...
                    <div>
                        ...
                        <span
                            className="cursor-pointer"
                            onClick={() =>
                                handleCopy(orderAddress.receiverPhone)
                            }
                        >
