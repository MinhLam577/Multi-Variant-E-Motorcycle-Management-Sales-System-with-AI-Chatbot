    ...
    return (
        <Spin tip="Loading..." spinning={loading}>
            ...
            <div className="mt-4">
                ...
                <div className="mt-4 italic flex justify-between">
                    <span className="pr-8">
                        2. Doanh thu khách hàng tiêu dùng:
                    </span>
                    <span className="text-[#EC2029]">{formatVNDMoney(0)}đ</span>
                </div>
                <div className="mt-4 italic flex justify-between">
                ...
                <div className="ml-0 italic mt-4">
                    <span className="pr-8">
                        5. Doanh thu cấp dưới trực tiếp:
                    </span>
                            ...
                            return (
                                <>
                                    <div className="w-[400px]">
                                        ...
                                        <div className="ml-0 flex italic justify-between mt-4">
                                            <span className="pr-8">
                                                Tổng doanh thu cấp dưới:
                                            </span>
                                            <span className="text-[#EC2029]">
                                                {formatVNDMoney(
                                                    child?.childrenRevenue
                                                )}
                                                đ
                                            </span>
                                        </div>
                                        <div className="ml-0 flex italic justify-between mt-4">
                                            ...
                                            <span className="text-[#EC2029]">
                                                {formatVNDMoney(
                                                    child?.retailRevenueFromReferences
                                                )}
                                                đ
                                            </span>
                                        </div>
                                        <div className="ml-0 flex italic justify-between mt-4">
                                            <span className="pr-8">
                                                {" "}
                                                Quy đổi doanh thu khách hàng
                                                tiêu dùng:
                                            </span>
                                            <span className="text-[#EC2029]">
                                                {formatVNDMoney(
                                                    child?.agencyRevenueFromReferences
                                                )}
                                                đ
                                            </span>
                                        </div>
