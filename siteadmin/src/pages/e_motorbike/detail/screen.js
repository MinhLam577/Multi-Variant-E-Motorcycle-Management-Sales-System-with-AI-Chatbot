                                            ...
                                            rules={[
                                                {
                                                    required: false,
                                                    message:
                                                        "Hãy nhập nội dung mô tả sản phẩm!",
                                                },
                                            ]}
                                        >
                                            <RichTextEditor
                                        ...
                                        <Row gutter={[16, 16]}>
                                            ...
                                            <Col span={12}>
                                                <Form.Item
                                                    ...
                                                    name="depositPrice"
                                                    tooltip={{
                                                        title: "Số tiền chưa giảm giá, thể hiện giá trị giảm giá, ưu đãi cho khách hàng",
                                                        icon: (
                                                            <InfoCircleOutlined />
                                                        ),
                                                    }}
                                                ...
                                                >
                                                    <Col span={12}>
                                                        <Form.Item
                                                            ...
                                                            name="sku"
                                                            tooltip={{
                                                                title: "SKU - Mã sản phẩm cho mỗi sản phẩm nên là duy nhất bao gồm cả chữ và số",
                                                                icon: (
                                                                    <InfoCircleOutlined />
                                                                ),
                                                            }}
                                                    ...
                                                    <Col span={12}>
                                                        <Form.Item
                                                            ...
                                                            name="barcode_id"
                                                            tooltip={{
                                                                title: "Barcode - Mã vạch thường được nhà sản xuất tạo ra",
                                                                icon: (
                                                                    <InfoCircleOutlined />
                                                                ),
                                                            }}
                                            ...
                                            >
                                                <Col span={24}>
                                                    <Checkbox>
                                                        ...
                                                        thể. Ví dụ như khác nhau
                                                        về kích thước, màu sắc
                                                    </Checkbox>
                                                </Col>
                                            </Form.Item>
                                            <Form.Item name={"variantModel"}>
                                                <Col span={24}>
                                                    {useWatch(
                                                        "variant",
                                                        form
