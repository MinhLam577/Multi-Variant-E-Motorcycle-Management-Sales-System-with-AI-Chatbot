const endpoints = {
    ...
    order: {
        ...
        confirmOrder: (id: string) => `/order/${id}/confirm`,
        exportOrder: (id: string) => `/order/${id}/export`,
        handOverOrder: (id: string) => `/order/${id}/hand-over`,
        deliveryOrder: (id: string) => `/order/${id}/deliver`,
        shipOrder: (id: string) => `/order/${id}/ship`,
        shipSuccess: (id: string) => `/order/${id}/ship-success`,
